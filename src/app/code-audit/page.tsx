...
export default async function CodeAuditPage() {
  ...
  return (
    <ProgramPageClient
      programs={programs}
      contentType="code_audit"
      title="Code Audit"
      description="Análisis estático de anti-patrones y problemas de calidad en el código COBOL fuente."
      icon="bug_report"
      accentColor="#ffb4ab"
    />
  );
